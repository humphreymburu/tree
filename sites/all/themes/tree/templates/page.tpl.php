	        ...
	        <div class="wrapper">
	           ...
	           <div class="row">
				 ...
				 <div class="large-4 columns">
	               <ul class="header_icons left">
  	              <?php if (theme_get_setting('twitter_icon') == '1' ): ?><li><a href="<?php echo theme_get_setting('twitter_url'); ?>" target="_blank"><i class="step fi-social-twitter size-18"></i></a></li><?php endif ?>
  	               <?php if (theme_get_setting('facebook_icon') == '1' ): ?><li><a href="<?php echo theme_get_setting('facebook_url'); ?>" target="_blank"><i class="step fi-social-facebook size-18"></i></a></li><?php endif ?>
			  ...
			  <?php if (!empty($page['top_region'])): ?>
		  	 ...
		  	 <div class="large-8 columns">
				   ...
				   <li><?php print render($page['top_region']); ?></li>
		       </ul>
	        </div>
		 <?php endif; ?> 
		  ...
		  <div class="row"> 
			  <div class="large-4 columns branding"><div class="logo">
